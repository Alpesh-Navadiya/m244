...
use Custom\Repo\Model\ResourceModel\Custom\Collection;
 ...
 */
class CustomRepository implements \Custom\Repo\Api\CustomRepositoryInterface
{
    /**
     * @var \Custom\Repo\Model\CustomFactory
     */
    ...
    /**
     * @var \Custom\Repo\Api\Data\CustomSearchResultInterfaceFactory
     */
    protected $searchResultInterfaceFactory;

    /**
     * CustomRepository constructor.
     * @param \Custom\Repo\Model\CustomFactory $customFactory
     * @param ResourceModel\Custom $customResource
     * @param ResourceModel\Custom\CollectionFactory $collectionFactory
     * @param \Custom\Repo\Api\Data\CustomSearchResultInterfaceFactory $searchResultInterfaceFactory
     */
    public function __construct(
        \Custom\Repo\Model\CustomFactory $customFactory,
        \Custom\Repo\Model\ResourceModel\Custom $customResource,
        \Custom\Repo\Model\ResourceModel\Custom\CollectionFactory $collectionFactory,
        \Custom\Repo\Api\Data\CustomSearchResultInterfaceFactory $searchResultInterfaceFactory
    ) {
