...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Custom_Repository::news_allnews')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Custom\Repository\Model\Allnews::class);
        ...
        $this->_coreRegistry->register('my_blog', $model);
